    ...
    traits_view = View(
        Group(
            Group(
                ...
                Item(
                    editor  = enthought.traits.ui.EnableRGBAColorEditor( mode = 'hsv' ),
                    name    = 'rgba_color',
                    style   = 'custom',
                    padding = -8
                ),
            ...
            Group(
                Item(
                    editor  = enthought.traits.ui.EnableRGBAColorEditor( mode = 'hsv2' ),
                    name    = 'rgba_color',
                    style   = 'custom',
                    padding = -8
                ),
                Item(
                    editor  = enthought.traits.ui.EnableRGBAColorEditor( mode = 'hsv3' ),
                    name    = 'rgba_color',
                    style   = 'custom',
                    padding = -8
                ),
