...
def declareImplementation(
    protocol, instancesProvide=(), instancesDoNotProvide=()
):
...
from traits.adaptation.adaptation_error import (
    AdaptationError as AdaptationFailure,
)
