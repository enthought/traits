...
TRAITSBACKENDWX = etsdep('TraitsBackendWX', '3.0.3')  # -- only from e.util.traits.editor.parameter_choice_editor.py
TRAITSGUI = etsdep('TraitsGUI', '3.0.3')  # -- from logger.(agent|plugin|widget)
