...
TRAITSBACKENDWX = etsdep('TraitsBackendWX', '3.2.1')  # -- only from e.util.traits.editor.parameter_choice_editor.py
TRAITSGUI = etsdep('TraitsGUI', '3.1.1')  # -- from logger.(agent|plugin|widget)
