...
A point object could be implemented in python with:
    ...
    `code snippet #0 <http://gael-varoquaux.info/computers/traits_tutorial/code_block0_py>`_
...
to open a dialog to edit its properties :
    ...
    `code snippet #1 <http://gael-varoquaux.info/computers/traits_tutorial/code_block1_py>`_
...
like (see the TraitsUI manual):
    ...
    `code snippet #2 <http://gael-varoquaux.info/computers/traits_tutorial/container_py>`_
...
loop in wx speech).
    ...
    `code snippet #3 <http://gael-varoquaux.info/computers/traits_tutorial/event_loop_py>`_
...
duplicated to output.
    ...
    `code snippet #4 <http://gael-varoquaux.info/computers/traits_tutorial/echo_box_py>`_
...
button:
    ...
    `code snippet #5 <http://gael-varoquaux.info/computers/traits_tutorial/interactive_py>`_
...
method:
    ...
    `code snippet #6 <http://gael-varoquaux.info/computers/traits_tutorial/thread_example_py>`_
...
modification to traits objects by hand in the event loop:
    ...
    `code snippet #7 <http://gael-varoquaux.info/computers/traits_tutorial/traits_thread_py>`_
...
displaying and positioning the editor.
    ...
    `code snippet #8 <http://gael-varoquaux.info/computers/traits_tutorial/mpl_figure_editor.py>`_
...
`tutorial's zip file <http://gael-varoquaux.info/computers/traits_tutorial/traits_tutorial.zip>`_ (it is the file `application.py`).
